...
Residual deviance is less than the Null deviance. We can see a siginificant decrease in the Null deviance. The p value is 5.606281e-11. The model is yes, since the p value is close to zero.
...
The Amount has been removed and has no effect on the model.
...
Sensitivity - ability to detect an outcome
